...
return [
    ...
    'plan_summaries' => [
        [
            ...
            'price' => '',
            'description' => 'Puesta en marcha segun volumen inicial y acompanamiento requerido.',
            'features' => [
                'Express: hasta 30 productos',
                'Esencial: hasta 100 productos',
                'Plus: hasta 250 productos',
            ],
        ],
        [
            'title' => 'Carga adicional',
            'price' => '',
            'description' => 'Ampliacion del catalogo despues de salir a operar.',
            'features' => [
                'Por unidad',
                'Pack 100',
                'Pack 250',
        ...
        [
            ...
            'price' => '',
            'description' => 'Soporte posterior, correcciones y mejoras menores.',
            'features' => [
                'Basico',
                'Operativo',
                'Prioritario',
