    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-slate-300">
                Esta accion elimina tu cuenta y sus datos de forma permanente.
                Asegurate de guardar cualquier informacion importante antes de continuar.
            </p>
        </header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                >
                    Confirma la eliminacion de tu cuenta
                </h2>
