                ...
                <article v-for="product in products.data" :key="product.id" class="rounded-xl border border-cyan-100/20 bg-slate-950/35 p-4 text-sm text-slate-300">
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <div class="flex shrink-0 gap-2">
                            <Link :href="route('products.inventory-adjustments.create', product.id)" class="rounded-lg bg-indigo-600 px-3 py-1 text-xs font-semibold text-white hover:bg-indigo-500">Ajustar</Link>
                            <Link :href="route('products.edit', product.id)" class="rounded-lg border border-cyan-100/25 px-3 py-1 text-xs font-semibold text-slate-300 hover:bg-slate-800/70">Editar</Link>
                        </div>
                    </div>
                    ...
                    <tbody v-if="products.data.length" class="divide-y divide-slate-100">
                        <tr v-for="product in products.data" :key="product.id" :class="productRowClass(product)">
                            ...
                            <td class="px-3 py-2 text-right">
                                <Link :href="route('products.inventory-adjustments.create', product.id)" class="mr-2 rounded-lg bg-indigo-600 px-3 py-1 text-xs font-semibold text-white hover:bg-indigo-500">
                                    Ajustar
                                </Link>
