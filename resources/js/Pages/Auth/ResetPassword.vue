    ...
    <div class="auth-bg min-h-screen text-slate-100">
        <div class="mx-auto grid min-h-screen w-full max-w-6xl grid-cols-1 items-center gap-8 px-6 py-10 lg:grid-cols-2">
            <section class="entry hidden rounded-3xl border border-cyan-200/20 bg-slate-900/30 p-8 lg:block">
                <p class="title text-xs uppercase tracking-[0.3em] text-cyan-200/80">Nuevo acceso</p>
                <h1 class="title mt-4 text-4xl font-bold leading-tight">
                    Define una nueva contrasena y vuelve a ingresar
                </h1>
                <p class="mt-4 max-w-xl text-slate-200/85">
                    Una vez guardada, podras volver a iniciar sesion con la nueva contrasena desde cualquier dispositivo.
                </p>

                <div class="mt-8 grid gap-3">
                    <div class="item">
                        <span class="dot" />
                        <p>Usa una contrasena segura y facil de recordar para vos.</p>
                    </div>
                    <div class="item">
                        <span class="dot" />
                        <p>Si ya no necesitas este enlace, simplemente puedes volver al login.</p>
                    </div>
                    <div class="item">
                        <span class="dot" />
                        <p>Despues podras ingresar normalmente con tu nuevo acceso.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="entry panel mx-auto w-full max-w-md">
                ...
                <h2 class="title mt-5 text-3xl font-bold text-white">Restablecer contrasena</h2>
                <p class="mt-2 text-sm text-slate-200/80">Completa estos datos para definir una nueva contrasena.</p>
                ...
                <form class="mt-6 space-y-4" @submit.prevent="submit">
                    ...
                    <div>
                        <label for="password" class="mb-1 block text-sm font-semibold text-slate-200">Nueva contrasena</label>
                        <input
                            id="password"
                    ...
                    <div>
                        <label for="password_confirmation" class="mb-1 block text-sm font-semibold text-slate-200">Confirmar contrasena</label>
                        <input
                            ...
                            class="field"
                        />
                        <p v-if="form.errors.password_confirmation" class="mt-1 text-xs text-rose-200">{{ form.errors.password_confirmation }}</p>
                    </div>
                    ...
                    <div class="flex items-center justify-end pt-2">
                        ...
                        >
                            {{ form.processing ? 'Guardando...' : 'Guardar contrasena' }}
                        </button>
                    </div>
                </form>
            </section>
