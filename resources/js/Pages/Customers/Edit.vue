        ...
        <form class="rounded-2xl border border-cyan-100/20 bg-slate-900/45 backdrop-blur p-5 shadow-sm" @submit.prevent="submit">
            <div class="grid gap-3 md:grid-cols-2">
                ...
                <div class="space-y-1">
                    ...
                    <input v-model="form.phone" type="text" class="w-full rounded-xl border-cyan-100/25 text-sm" />
                ...
                <div class="space-y-1">
                    ...
                    <input v-model="form.email" type="email" class="w-full rounded-xl border-cyan-100/25 text-sm" />
                ...
                <div class="space-y-1 md:col-span-2">
                    ...
                    <input v-model="form.address" type="text" class="w-full rounded-xl border-cyan-100/25 text-sm" />
                ...
                <div class="space-y-1 md:col-span-2">
                    ...
                    <textarea v-model="form.notes" rows="3" class="w-full rounded-xl border-cyan-100/25 text-sm" />
                ...
                <div class="space-y-1 md:col-span-2">
                    ...
                    <textarea v-model="form.reminder_notes" rows="3" class="w-full rounded-xl border-cyan-100/25 text-sm" />
