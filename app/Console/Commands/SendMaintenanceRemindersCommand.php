...
use App\Services\MaintenanceReminderNotificationService;
...
class SendMaintenanceRemindersCommand extends Command
{
    protected $signature = 'notifications:send-maintenance-reminders
        ...
        {--force : Envia aunque no falten exactamente 7 dias}';

    protected $description = 'Procesa y envia recordatorios de mantenimiento por vencer';

    public function __construct(private readonly MaintenanceReminderNotificationService $notificationService)
    {
        parent::__construct();
    }
